    ...
    >
      ...
      >
        ...
        <a
          ...
          className="bg-white p-4 flex items-center gap-2 rounded-full outline-none focus:scale-[1.15] hover:scale-[1.15] hover:text-gray-950 active:scale-105 transition cursor-pointer border border-black/10"
          target="_blank"
        >
          <BsLinkedin />
        </a>
